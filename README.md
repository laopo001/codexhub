...
```bash
pnpm codexp --api http://127.0.0.1:18788 connect -C /path/to/project
```
...
```bash
pnpm codexp --api http://127.0.0.1:18788 task template daily-summary
pnpm codexp --api http://127.0.0.1:18788 task ls
pnpm codexp --api http://127.0.0.1:18788 task daemon
```
