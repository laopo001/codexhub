...
CodexHub 0.8.1 要求运行 machine 上的官方 Codex CLI 不低于 `0.144.4`。VSCode 0.8.1 延续 authority 级共享服务，并优先使用本机 Node.js 与 npm/link 安装的 CodexHub 包；升级前请先阅读 [0.8.0 迁移说明](./MIGRATION.md)。
